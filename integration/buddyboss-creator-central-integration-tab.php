 ...
 * @since BuddyBoss 1.1.5
 */
class CREATORCENTRAL_PLUGIN_BuddyBoss_Admin_Integration_Tab extends BP_Admin_Integration_tab {
	...
	public function register_fields() {
		...
		$sections = CREATORCENTRAL_PLUGIN_get_settings_sections();

		foreach ( (array) $sections as $section_id => $section ) {

			// Only add section and fields if section has fields
			$fields = CREATORCENTRAL_PLUGIN_get_settings_fields_for_section( $section_id );
